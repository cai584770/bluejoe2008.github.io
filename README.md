...
* 刘峰,周园春,韩芳,等.一种通用的分布式异构数据一体化物理汇聚、组织、发布与服务方法及系统.202010020974.1,2023-06-27.
* 李亮,沈志宏,周园春,等.一种面向大数据的深度学习方法及系统.北京:CN201611020935.1,2017-04-19.
...
* 阎保平,黎建辉,周园春,等.可定制的移动数据采集系统.北京:CN200920110708.7,2010-11-17.
